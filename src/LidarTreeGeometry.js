import lidar from "./agroforestry.json";
...
export default class LidarTreeGeometry extends BufferGeometry {
  constructor(radialSegments = 7) {
    ...
    const addRing = (frameIndex) => {
      ...
      if (frameIndex % 2 == 0) normals.push(-tangent.x, -tangent.y, -tangent.z);
